...
## [1.5.0] - 2023-10-25 - 2023-10-25

### Changed

- Replaced `@next-boost/hybrid-disk-cache` package with the updated version `@udisc/hybrid-disk-cache` to fix Node v20/better-sqlite3 dependency issues.
...
- Replaced `hybrid-disk-cache` package with the updated version `@udisc/hybrid-disk-cache`
